...
a:hover{
  ...
  <body>
    ...
    margin-right:30px ;">Home</a></li>
          <li class="nav-content"><a class="nav-link" href="appointment.php" style="text-decoration: none;
    color:white;    
          ...
          <div class="row mt-4">
             ...
             <div class="col-md-3 mb-2">
               <div class="card text-bg-primary mb-3">
                 <div class="card-body">
                   <h5 class="card-title"><i class="fas fa-user"></i> Appointment</h5>
                   <p class="card-text"></p>
                 </div>
               </div>
             </div>
             <div class="col-md-3 mb-2">
               <div class="card text-bg-danger mb-3">
                 <div class="card-body">
                   <h5 class="card-title"><i class="fas fa-female"></i>Rejected Appointment </h5>
                   <p class="card-text"></p>
                 </div>
               </div>
             </div>
             <div class="col-md-3 mb-2">
               <div class="card text-bg-success mb-3">
                 <div class="card-body">
                   <h5 class="card-title"><i class="fas fa-user-secret"></i> Accepted Appointment</h5>
                   <p class="card-text"></p>
                 </div>
               </div>
             </div>
 ...
 <?php
            ...
            //echo $beautician_name;
               $sql = "SELECT* from book_appointment where beautician='$beautician_name' ";
   ...
   if ($result -> num_rows > 0) {
       while($row = $result->fetch_assoc()) {
          ...
          // </td>';
          echo '<td>
        <a href="viewdetails.php?UserID=' . htmlspecialchars($row['UserID']) . '" class="btn btn-success">View Details</a> &nbsp;
        <button type="button" class="btn btn-danger">Cancel</button>
      </td>';
