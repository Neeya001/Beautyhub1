    ...
    <li class="nav-item">
            ...
            <div class="container-fluid">
               <div class="row mt-4">      
                ...
                <div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Beautician Details</strong> Check Out Beauticians Details Below
                ...
                <div class="row" style="height: 70vh; overflow: auto;">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th data-field = "Salon">Salon Name</th>
          ...
          if ($result -> num_rows > 0) {
              while($row = $result->fetch_assoc()) {
                  ...
                  echo "   <td> <a href='beautician_details.html'>View Details</a> </td>";
                  echo "</tr>";
              }
          } else {
